<template>
    <div class="flex min-h-[calc(100vh-3.5rem)] flex-col items-center justify-center px-6">
        ...
        <!-- Subtle footer -->
        <div class="mt-16 font-mono text-xs" :class="isDark ? 'text-slate-700' : 'text-slate-300'">
            &lt;/&gt; with ☕ by RJSOG
        </div>
